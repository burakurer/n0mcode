                        ...
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="avatar avatar-online">
                                ...
                                <?php }
                                    ...
                                    <img src="https://mami.wtf/n0mcode/theme/dox/images/usernone.png" alt="avatar">
                                <?php } ?>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online">
                                ...
                                <a class="dropdown-item" href="#"><i class="ft-activity"></i>İp adresiniz: <?php echo $_SERVER["HTTP_CF_CONNECTING_IP"]; ?>
