                                            ...
                                            <div class="form-body">
                                                <form method="POST" action="n0mSystem/n0mGuard.php">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="baslik" class="form-control" name="code_baslik" value="<?php echo $vericek['code_baslik'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="icerik" rows="25" name="code_icerik"><?php echo $vericek['code_icerik'] ?></textarea>
                                                    </div>
                                                </div>
