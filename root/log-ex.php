                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <h5 for="sahip">Hcaptcha durumu</h5>
                                                    <input type="text" id="sahip" class="form-control" readonly="readonly" value="<?php if($vericek['log_hcaptcha'] == 1){ echo 'başarılı'; }else{ echo 'başarısız'; } ?>">
                                                </div>
                                                <div class="form-group">
