                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <p class="card-text">Kayıtlı kullanıcıların listesi, kullanıcıları güncelleyebilir, inceleyebilir, silebilirsiniz.</p>
                                                </div>
                                                                ...
                                                                <tr>
                                                                    <?php if(!empty($listele['user_picture'])){ ?>
                                                                        <td style="vertical-align: middle;">
                                                                            <img style="height: 75px; border-radius: 50%; width: 75px; border: 2px solid purple" src="<?php echo htmlspecialchars($listele['user_picture']); ?>">
                                                                        </td>
                                                                    <?php }
                                                                    else{ ?>
                                                                        <td style="vertical-align: middle;">
                                                                            ...
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 40px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                    <form method="POST" action="user-ex">
                                                                                        <input type="text" name="secret" hidden="" value="<?php echo $listele['user_secret']; ?>">
                                                                                    ...
                                                                                    <form method="POST" action="user-codes">
                                                                                        <input type="text" name="secret" hidden=""value="<?php echo $listele['user_secret']; ?>">
                                                                                        <button class="dropdown-item" name="user_codes" type="submit"><i class="ft-eye"></i> Kodlarını görüntüle</button>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                        </center>
