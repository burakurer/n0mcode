                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                require_once 'n0mSystem/n0mGuard.php';
                                                                n0mLogDB_Connect();
                                                                $log=$db->prepare("SELECT * FROM `n0mlog` ORDER BY `n0mlog`.`log_id` DESC LIMIT 4");
                                                                $log->execute();
                                                                $say=0;
                                                                        ...
                                                                        <td style="vertical-align: middle;">
                                                                            <center>
                                                                                <form method="POST" action="log-ex">
                                                                                    ...
                                                                                    <button class="btn btn-round btn-outline-info btn-min-width" name="log_ex" type="submit" ><i class="ft-info"></i> İncele</button>
                                                                                </form>
                                                                            </center>
                                                                        </td>
                                                                    </tr>
