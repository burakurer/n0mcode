                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Veritabanındaki kodların listesi</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <p class="card-text">Kullanıcıların eklediği bütün kodların listesi, kodları inceleyebilir, düzenleyebilir silebilirsiniz.</p>
                                                </div>
