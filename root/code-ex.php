...
<head>
    ...
    <title>n0mCode - Kod Veritabanı</title>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            if (isset($_POST['code_ex'])){
                                $id = $_POST['id']; 
                                $vericek = $db->query("SELECT * FROM code WHERE code_id = '$id'")->fetch(PDO::FETCH_ASSOC);
                                if ( $vericek ){ ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="sahip" class="form-control" readonly="readonly" value="<?php echo $vericek['code_sahip'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 for="baslik">Başlık</h5>
                                                    <input type="text" id="baslik" class="form-control" readonly="readonly" value="<?php echo $vericek['code_baslik'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 for="tarih">Eklenme tarihi</h5>
                                                    <input type="text" id="tarih" class="form-control" readonly="readonly" value="<?php echo $vericek['code_tarih'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    if ($vericek['code_public'] == "1") { ?>
                                                        <input type="text" id="tarih" class="form-control" readonly="readonly" value="<?php echo "açık" ?>">
                                                    <?php }
                                                    else { ?>
                                                        <input type="text" id="tarih" class="form-control" readonly="readonly" value="<?php echo "kapalı" ?>">
                                                    <?php } ?>
                                                </div>
                                                <div class="form-group">
                                                    <h5 for="icerik">Kod içeriği</h5>
                                                    <textarea class="form-control" id="icerik" rows="25" readonly="readonly"><?php echo $vericek['code_icerik'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-actions">
                                                <form method="POST" action="code-update">
                                                    <center>
                                                        ...
                                                        <button type="submit" name="code_update" class="btn btn-round  btn-outline-warning"><i class="ft-edit"></i> Düzenle</button>
                                                    </form>
