...
<head>
	...
	<title>n0mCode - Kullanıcı kodları</title>
...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">
	...
	if (@$_GET['x'] == "success") { ?>
		...
		<meta http-equiv="refresh" content="3;code-database">
	<?php }
	if (@$_GET['x'] == "error") { ?>
		<script>
			const Toast = Swal.mixin({
		...
		<div class="content-wrapper">
			...
			<div class="content-header row">
				<div class="content-header-left col-md-4 col-12 mb-2">
					<h3 class="content-header-title">Kullanıcı kodları</h3>
				</div>
			</div>
					...
					<div class="col-xl-12 col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Kullanıcı kodlarını görüntüle</h4>
							</div>
														...
														if (isset($_POST['user_codes'])){
															...
															if ( $vericek ){
																...
																while ($listele=$code->fetch(PDO::FETCH_ASSOC)) { $say++;
																	...
																	if ($say1 == 0) {
																		echo "<tr><td>Kullanıcıya ait kod bulunamadı</tr></td>";
																	}
																}
															}else{
