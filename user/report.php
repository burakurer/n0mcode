...
<head>
	...
	<title>n0mCode - Yöneticiye bildir</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header row">
				<div class="content-header-left col-md-4 col-12 mb-2">
					<h3 class="content-header-title">Yöneticiye bildir</h3>
				</div>
			</div>
								...
								if (isset($id)) {
									...
									if ($cek) { ?>
										<div class="card-content">
											<div class="card-body">
												<h3 class="card-title">Şuan <?php echo $cek['code_baslik']; ?> başlıklı kodu yöneticiye bildiriyorsunuz.</h3>
												<div class="form-body">
													<form method="POST" action="xo/functions.php">
														<div class="form-group">
															<h5 for="baslik">Başlık</h5>
															<p type="text" id="baslik" name="code_baslik"><?php echo $cek['code_baslik'] ?></p>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="icerik" rows="25" name="code_icerik"></textarea>
														</div>
													</div>
													<div class="form-actions">
														<center>
															<button type="submit" name="12" class="btn btn-round  btn-outline-success"><i class="ft-save"></i> Kaydet</button>
														</form>
														<a href="my-codes">
