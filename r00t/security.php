...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">
    ...
    if (@$_GET['x'] == "success") { ?>
        ...
        <meta http-equiv="refresh" content="3;log-database">
    <?php }
    if (@$_GET['x'] == "error") { ?>
        <script>
            const Toast = Swal.mixin({
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php                                                            require_once 'xo/functions.php';
                                                        dbLogConnect();
                                                        ...
                                                        while ($listele=$log->fetch(PDO::FETCH_ASSOC)) { $say++; ?>
                                                            <tr>
                                                                ...
                                                                <td style="vertical-align: middle;">
                                                                    <?php if($listele['log_recaptcha'] == 1){ ?>
                                                                        <div style="font-size: 30px"><i class="ft-check-circle"></i></div>
                                                                    <?php }else{ ?>
                                                                        <div style="font-size: 30px"><i class="ft-x-circle"></i></div>
                                                                    <?php } ?>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 40px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                <form method="POST" action="log-ex">
                                                                                    ...
                                                                                    <button class="dropdown-item" name="log_ex" type="submit"><i class="ft-eye"></i> İncele</button>
                                                                                </form>
                                                                                <form method="POST" target="_blank" action="http://localhost/dox/ip-sorgula/sorgu">
