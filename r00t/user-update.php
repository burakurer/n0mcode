                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            if (isset($_POST['user_update'])){
                                $id = $_POST['id']; 
                                $vericek = $db->query("SELECT * FROM user WHERE user_id = '$id'")->fetch(PDO::FETCH_ASSOC);
                                if ( $vericek ){ ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-body">
                                                <form method="POST" action="xo/functions.php">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>Kullanıcı adı</h5>
                                                        <input type="text" class="form-control" name="user_name" value="<?php echo htmlspecialchars($vericek['user_name']) ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <h5>Hesap türü</h5>
                                                        <select class="custom-select" name="user_yetki">
                                                            <?php
                                                            if ($vericek['user_yetki'] == "admin") { ?>
